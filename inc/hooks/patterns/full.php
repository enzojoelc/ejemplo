...
return array(
    ...
    <h2 class="wp-block-heading">' . esc_html__( 'Express Grid', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading">' . esc_html__( 'About Author', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Post Slider', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Post Grid', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Post List', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Connect to Us', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Advertisement', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"full","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignfull"><!-- wp:heading {"align":"full"} -->
    <h2 class="wp-block-heading alignfull">' . esc_html__( 'Post Carousel', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <div class="wp-block-column" style="flex-basis:70%"><!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Express Tile', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group {"align":"wide","layout":{"type":"constrained"}} -->
    <div class="wp-block-group alignwide"><!-- wp:heading {"align":"wide"} -->
    <h2 class="wp-block-heading alignwide">' . esc_html__( 'Single Column', 'covernews' ) . ' </h2>
    <!-- /wp:heading -->
    ...
    <!-- wp:group -->
    <div class="wp-block-group"><!-- wp:heading -->
    <h2 class="wp-block-heading">' . esc_html__( 'Categories', 'covernews' ) . '</h2>
    <!-- /wp:heading -->
