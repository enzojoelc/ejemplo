 ...
 */
class CoverNews_Dropdown_Taxonomies_Control extends WP_Customize_Control {
    ...
    public function render_content() {
        ...
        <label>
            ...
            <select <?php $this->link(); ?>>
                <?php
                printf( '<option value="%s" %s>%s</option>', 0, selected( $this->value(), '', false ), __( 'All', 'covernews' )  );
                ?>
 ...
 * @see WP_Customize_Control
 */
class CoverNews_Radio_Image_Control extends WP_Customize_Control {
 ...
 * @see WP_Customize_Control
 */
class CoverNews_Simple_Notice_Custom_Control extends WP_Customize_Control
{
    /**
 ...
 * @access public
 */
class CoverNews_Customize_Section_Upsell extends WP_Customize_Section {
